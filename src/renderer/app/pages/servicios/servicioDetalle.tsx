...
import { Comment } from "@/src/renderer/interfaces/Comments.interface";
import { serviceGetAllUsers } from "@/src/renderer/services/users.service";
import EditServiceForm from "./servicioEditar";
...
import { serviceAddComment, serviceGetComments, serviceToggleLike } from "@/src/renderer/services/comments.service";
import { Service } from "@/src/renderer/interfaces/Service.interface";
import { serviceGetServiceById } from "@/src/renderer/services/services.service";
        ...
        <div className="w-full flex flex-col items-end px-12">
          ...
          >
            {authUser?.rol === "admin" || authUser?.rol === "personal" ? (
              ...
              <Link
                to={`${!authUser ? "/auth/login" : "/turnos/" + params.slug}`}
